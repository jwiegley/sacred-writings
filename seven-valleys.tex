...
%%TODO%%
\ayat{و اگر در اين سفر به اِعانَتِ باری از يارِ بينِشان نِشان يافت}
     {And if, by the help of God, he findeth on this journey a trace of the traceless Friend,}

\ayat{و بویِ يوسُفِ گُمگَشتِه از بَشيرِ اَحَدِيِّه شنيد}
     {and inhaleth the fragrance of the long-lost Joseph from the heavenly messenger,}

\ayat{فُوراً به وادیِ عِشق قَدَم گُذارَد و از نارِ عِشق بِگُدازَد}
     {he shall straightway step into the Valley of Love and be dissolved in the fire of love.}

\ayat{دَر اين شَهر آسمانِ جَذب بُلَند شود و آفتابِ جَهانتابِ شُوق طالِع گردد و نارِ عِشق بَراَفروزَد}
...
\ayat{و چون نارِ عِشق بَر اَفروخت خَرمَنِ عَقل به کُلی بِسوخت}
     {and when the fire of love is ablaze, it burneth to ashes the harvest of reason.}

\ayat{دَر اين وَقت سالِک از خُود و غِيرِ خُود بيخَبَر است}
     {Now is the traveler unaware of himself, and of aught besides himself.}

\ayat{نَه جَهل و عِلم دانَد و نَه شَکّ و يَقين نَه صُبحِ هِدايَت شِناسَد و نَه شامِ ضِلالَت}
